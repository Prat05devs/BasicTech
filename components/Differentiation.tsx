  ...
  return (
    <section className="py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 relative z-10">
        <div className="mb-20">
          <Reveal>
             <h2 className="text-4xl md:text-5xl font-semibold text-slate-900 mb-6 tracking-tight leading-tight">Why We're Different</h2>
          </Reveal>
        </div>
          ...
          {PILLARS.map((pillar, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-3 tracking-tight leading-tight">{pillar.title}</h3>
                <p className="text-slate-600 font-light leading-relaxed text-[15px] sm:text-base">{pillar.subtitle}</p>
