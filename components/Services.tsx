  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 bg-white relative">
      <div className="container mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12">
        <Reveal width="100%">
          <h3 className="text-xs sm:text-sm font-semibold tracking-widest text-brand-blue uppercase mb-8 sm:mb-10 md:mb-12 leading-none">What We Do</h3>
        </Reveal>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-center md:items-center">
                <div className="flex items-center gap-3 sm:gap-4">
                   ...
                   />
                   <h4 className={`text-xl sm:text-2xl md:text-3xl font-medium tracking-tight transition-colors duration-300 ${hoveredIndex === index ? 'text-brand-blue' : 'text-slate-900'} leading-[1.2]`}>
                     {service.title}
                   </h4>
                </div>
                <p className="text-base sm:text-lg md:text-lg text-slate-600 font-light md:pl-8 leading-relaxed mt-2 sm:mt-0">
                  {service.description}
                </p>
              </div>
            </motion.div>
